...
test_that("list_ekio_palettes returns correct structure", {
  ...
  expect_true("purple_orange" %in% list_ekio_palettes("diverging"))
  expect_false("blue_orange" %in% list_ekio_palettes("diverging"))
  expect_true("purple_green" %in% list_ekio_palettes("diverging"))
