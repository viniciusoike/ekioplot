...
`"blue"`, `"gray"`, `"teal"`, `"orange"`, `"purple"`, `"red"`, `"green"`, and
`"amber"` — are nine-step ramps running light to dark, named by shade:
...
from ekioplot via `ekio_pal()` and `ekio_font()`, so tables and charts share
one palette without either package duplicating color definitions.
