...
- **Sequential**: `blue`, `gray`, `stone`, `teal`, `green`, `gold`, `orange`,
  `red`
...
Every brand color is reached through `ekio_pal()`. The eight brand scales —
`"blue"`, `"gray"`, `"stone"`, `"teal"`, `"green"`, `"gold"`, `"orange"`, and
`"red"` — are nine-step ramps running light to dark, named by shade. All eight
sit on one lightness spine, so a given shade carries the same visual weight in
every family:
